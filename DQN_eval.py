...
# TODO depreciated and can be removed soon
...
if __name__ == '__main__':
    ...
    parser.add_argument('--load', help='load model',default='/vol/biomedic2/av2514/PycharmProjects/DEVLandmarkDetection/DQN/train_log/Cardiac_with_19points/model-350000')
    ...
    parser.add_argument('--algo', help='algorithm',
                        ...
                        default='DQN')
    parser.add_argument('--files', type=argparse.FileType('r'), nargs='+', default= ('/vol/biomedic2/aa16914/shared/thanos/data/cardiac_test_files_copy.txt', '/vol/biomedic2/aa16914/shared/thanos/data/cardiac_test_landmarks_copy.txt'),
    ...
    if args.task != 'train':
        ...
        if args.task == 'play':
            play_n_episodes(get_player(files_list=args.files, viz=0.01,
                            ...
                            pred, num_files,agents=args.agents,reward_strategy=args.reward_strategy)
